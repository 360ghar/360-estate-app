...
import 'package:estate_app/features/leases/presentation/bindings/lease_create_bindings.dart';
...
import 'package:estate_app/features/leases/presentation/pages/lease_create_page.dart';
...
import 'package:estate_app/features/tenants/presentation/bindings/tenant_create_bindings.dart';
...
import 'package:estate_app/features/tenants/presentation/pages/tenant_create_page.dart';
...
abstract final class AppPages {
  static final pages = <GetPage<dynamic>>[
    ...
    // Property routes - IMPORTANT: specific routes must come before parameterized :id routes
    GetPage(
    ...
    // Tenant routes - IMPORTANT: specific routes must come before parameterized :id routes
    GetPage(
      name: Routes.tenantCreate,
      page: TenantCreatePage.new,
      bindings: [
        TenantsBindings(),
        TenantCreateBindings(),
      ],
      middlewares: [AuthMiddleware()],
    ),
    GetPage(
    ...
    // Lease routes - IMPORTANT: specific routes must come before parameterized :id routes
    GetPage(
      name: Routes.leases,
      page: LeasesPage.new,
    ...
    GetPage(
      name: Routes.leaseCreate,
      page: LeaseCreatePage.new,
      bindings: [
        LeasesBindings(),
        PropertiesBindings(),
        TenantsBindings(),
    ...
    // Maintenance routes - IMPORTANT: specific routes must come before parameterized :id routes
    GetPage(
    ...
    // Inspections routes - IMPORTANT: specific routes must come before parameterized :id routes
    GetPage(
    ...
    // Applications routes - IMPORTANT: specific routes must come before parameterized :id routes
    GetPage(
