...
// data source for leases. The legacy `LeasesRepositoryImpl` (see
// `lib/features/leases/data/leases_repository.dart`) remains the wired-up
// implementation and is used by every provider/UI in this feature.
//
...
// B1) but keep the file as part of the in-progress migration so the diff
