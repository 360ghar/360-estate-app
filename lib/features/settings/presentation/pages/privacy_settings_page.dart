...
class PrivacySettingsPage extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final profileVisibility = privacy['profileVisibility'] ?? 'public';
    final analyticsEnabled = privacy['analyticsEnabled'] == 'true';
    final crashReportingEnabled = privacy['crashReportingEnabled'] == 'true';
    ...
    return AppScaffold(
      ...
      body: Column(
        children: [
          ...
          AppSectionCard(
            title:
                context.l10n?.profileVisibilitySection ?? 'Profile Visibility',
            ...
            children: [
              _PrivacyRadioTile(
                ...
                description:
                    context.l10n?.visibilityPublicDesc ??
                    'Anyone can see your profile',
                value: 'public',
                groupValue: profileVisibility,
                onChanged: (value) =>
                    _updatePrivacy(ref, 'profileVisibility', value),
              ),
              _tileDivider(isDark),
              _PrivacyRadioTile(
                ...
                description:
                    context.l10n?.visibilityContactsDesc ??
              ...
              _PrivacyRadioTile(
                ...
                description:
                    context.l10n?.visibilityPrivateDesc ??
          ...
          AppSectionCard(
            ...
            children: [
              ...
              _PrivacyToggleTile(
                ...
                description:
                    context.l10n?.crashReportingDesc ??
                    'Automatically report crashes to help us fix bugs',
                value: crashReportingEnabled,
                onChanged: (value) {
                  // Persisted; honored at next launch by bootstrap (see
                  // bootstrap.dart) since the crash reporter is created once
                  // at startup.
                  _updatePrivacy(
                    ref,
          ...
          AppSectionCard(
            ...
            children: [
              ...
              _PrivacyActionTile(
                ...
                description:
                    context.l10n?.clearActivityDesc ??
            ...
            FilledButton(
              onPressed: () {
                ...
                ScaffoldMessenger.of(context).showSnackBar(
                  SnackBar(
                    content: Text(
                      context.l10n?.dataDownloadStarted ??
                          'Data export started',
                    ),
                  ),
                );
...
// Privacy preferences provider — persisted through AppPreferences so choices
// survive app restarts (they previously were display-only no-ops).
final privacyPreferencesProvider =
    StateNotifierProvider<PrivacyPreferencesNotifier, Map<String, String>>(
      (ref) => PrivacyPreferencesNotifier(ref.read(appPreferencesProvider)),
    );

class PrivacyPreferencesNotifier extends StateNotifier<Map<String, String>> {
  PrivacyPreferencesNotifier(this._prefs) : super(_loadInitial(_prefs));
  ...
  static const Map<String, String> _prefKeys = {
    'profileVisibility': PrefKeys.profileVisibility,
    'phoneVisibility': PrefKeys.phoneVisibility,
    'emailVisibility': PrefKeys.emailVisibility,
    'analyticsEnabled': PrefKeys.analyticsEnabled,
    'crashReportingEnabled': PrefKeys.crashReportingEnabled,
  };

  static Map<String, String> _loadInitial(AppPreferences prefs) {
    return _defaults.map(
      (key, fallback) =>
          MapEntry(key, prefs.getString(_prefKeys[key]!) ?? fallback),
    );
  }
  ...
  void setPreference(String key, String value) {
    ...
    if (prefKey != null) {
      ...
      unawaited(_prefs.setString(prefKey, value));
    }
  }
}
